    ...
    <view class="tabbar">
      ...
      >
        <view
          ...
          :class="{ active: currentPath === item.path }"
        >
          image class="tab-icon" :class="{ active: currentPath === item.path }"
          :src="$cloudAssetUrl(item.icon)" mode="aspectFill" />
        </view>
...
.tab-icon-wrap {
  ...
  background: linear-gradient(
    180deg,
    rgba(245, 250, 244, 0.98) 0%,
    rgba(233, 243, 231, 0.98) 100%
  );
  box-shadow: 0 6rpx 12rpx rgba(47, 93, 58, 0.08);
...
.tab-icon-wrap.active {
  ...
  box-shadow: 0 12rpx 28rpx rgba(47, 93, 58, 0.14);
