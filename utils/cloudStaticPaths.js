...
// 云存储里真实可用的 fileID 前缀。
// 注意：这不是简单的 cloud://环境ID/static/...，而是你在云存储控制台里看到的完整前缀。
// 当前值按你提供的示例填写，如环境变更或前缀变更，需要同步更新这里。
export const CLOUD_FILE_ID_PREFIX =
  "cloud://cloud1-d6gqqruqy1d721eb0.636c-cloud1-d6gqqruqy1d721eb0-1435593477/";
...
export function buildCloudFileIds(envId) {
  ...
  return STATIC_FILES.map((relativePath) => ({
    relativePath,
    fileID: `${CLOUD_FILE_ID_PREFIX}${relativePath}`,
  }));
}
